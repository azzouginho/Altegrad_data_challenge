...
This module provides tools for preprocessing molecular graphs, generating embeddings, and training models for molecular-to-text alignment using graph neural networks and language models. You can find details on the project instructions in 'instructions.pdf'.

## Report 

The file `report.pdf` contains the report and details about our model presenting the method.
